![Visitor Count](https://komarev.com/ghpvc/?username=tiago-aguiar-moreira&color=0e76a8&style=flat-square&label=Visitantes+do+perfil)

<h1>👋 Olá, eu sou o Tiago Aguiar</h1>

<h3>💻 Desenvolvedor Sênior Back-end | C# & .NET | Criador de Conteúdo</h3>

---

### 🧑‍💻 Sobre mim

- 🚀 Mais de **13 anos de experiência** como desenvolvedor, com foco em **back-end** (e passagens por fullstack)
- 🔧 Minha principal linguagem é **C#**, com profundidade em boas práticas como **SOLID**, **Clean Code** e **testes unitários**
- 📡 Pioneiro na implementação de **SSE (Server-Sent Events)** para transmissão de dados em tempo real na minha área
- 🔁 Experiência com mensageria assíncrona (**Kafka**, **RabbitMQ**), integração via **REST/SOAP**, **FTP/SFTP schedulers** e modernização de sistemas legados
- ⚙️ Automação de CI/CD com **Azure DevOps** e **Octopus Deploy**
- 🎓 Bacharel em **Ciências da Computação** com duas pós-graduações
- 📺 Criador de conteúdo: canal **[Aguiar Dev](https://www.youtube.com/channel/UCYVc5vBX8v3Hk-Z9TNFcbNQ)** no YouTube, podcast **[Aguiar Dev Talks](https://open.spotify.com/show/4O1AS5tQc4aOGenOnaD0Zr)** e artigos no **iMasters**
- 📍 São Paulo, Brasil
